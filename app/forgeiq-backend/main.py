...
from app.forgeiq-backend.auth import get_private_intel_client  # ✅ Absolute import
from .auth import get_private_intel_client  # ✅ Relative import for internal modules
