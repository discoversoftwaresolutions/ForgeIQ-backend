    ...
    class EmbeddingModelService:
        ...
        def __init__(self, model_name: str = MODEL_NAME):
            ...
            if EmbeddingModelService._model is None or self.model_name != EmbeddingModelService._model.model_name_or_path: # type: ignore
                try:
                    ...
                    # You might want to raise this exception or handle it more gracefully
                    # so services know the embedding model isn't available.
        ...
        def model(self) -> SentenceTransformer:
            if EmbeddingModelService._model is None:
                # This should ideally not happen if constructor succeeded or raised
        ...
        def get_embedding_dimension(self) -> int:
            ...
            try:
                ...
                else: # Should not happen with standard sentence-transformers
        ...
        def generate_embeddings(self, texts: Union[str, List[str]], show_progress_bar: bool = False) -> List[List[float]]:
            ...
            try:
                ...
                #tolist() converts numpy array to Python list of lists
                ...
                # Return list of empty lists or raise, depending on desired error handling
